...
void VBS::Init()
{
  ...
  addHistogram("dR_l1_l2",80,0,12); //added by me!
  ...
  addHistogram("dR_j1_j2",80,0,12); //added by me!
  addHistogram("dR_j1_j3",80,0,12); //added by me!
  addHistogram("dR_j1_j4",80,0,12); //added by me!
  addHistogram("dR_j1_j5",80,0,12); //added by me!
  addHistogram("dR_j1_j6",80,0,12); //added by me!
  addHistogram("dR_j2_j3",80,0,12); //added by me!
  addHistogram("dR_j2_j4",80,0,12); //added by me!
  addHistogram("dR_j2_j5",80,0,12); //added by me!
  addHistogram("dR_j2_j6",80,0,12); //added by me!
  addHistogram("dR_j3_j4",80,0,12); //added by me!
  addHistogram("dR_j3_j5",80,0,12); //added by me!
  addHistogram("dR_j3_j6",80,0,12); //added by me!
  addHistogram("dR_j4_j5",80,0,12); //added by me!
  addHistogram("dR_j4_j6",80,0,12); //added by me!
  addHistogram("dR_j5_j6",80,0,12); //added by me!

  addHistogram("dR_bj1_bj2",80,0,12); //added by me!
  addHistogram("dR_bj1_bj3",80,0,12); //added by me!
  addHistogram("dR_bj1_bj4",80,0,12); //added by me!
  addHistogram("dR_bj2_bj3",80,0,12); //added by me!
  addHistogram("dR_bj2_bj4",80,0,12); //added by me!
  addHistogram("dR_bj3_bj4",80,0,12); //added by me!
...
void VBS::ProcessEvent(AnalysisEvent *event)
{
  ...
  if(countObjects(candJets, 20, 5, NOT(LooseBadJet))!=0) return;
  ...
  if (signalJets.size()>1) dR_j1_j2 = signalJets[0].DeltaR(signalJets[1]);
  float dR_j1_j3 = -999; //me
  if (signalJets.size()>2) dR_j1_j3= signalJets[0].DeltaR(signalJets[2]);
  float dR_j1_j4 = -999; //me
  if (signalJets.size()>3) dR_j1_j4= signalJets[0].DeltaR(signalJets[3]);
  float dR_j1_j5 = -999; //me
  if (signalJets.size()>4) dR_j1_j5= signalJets[0].DeltaR(signalJets[4]);
  float dR_j1_j6 = -999; //me
  if (signalJets.size()>5) dR_j1_j6= signalJets[0].DeltaR(signalJets[5]);
  float dR_j2_j3 = -999; //me
  if (signalJets.size()>2) dR_j2_j3= signalJets[1].DeltaR(signalJets[2]);
  float dR_j2_j4 = -999; //me 
  if (signalJets.size()>3) dR_j2_j4= signalJets[1].DeltaR(signalJets[3]);
  float dR_j2_j5 = -999; //me
  if (signalJets.size()>4) dR_j2_j5= signalJets[1].DeltaR(signalJets[4]);
  float dR_j2_j6 = -999; //me
  if (signalJets.size()>5) dR_j2_j6= signalJets[1].DeltaR(signalJets[5]);
  float dR_j3_j4 = -999; //me 
  if (signalJets.size()>3) dR_j3_j4= signalJets[2].DeltaR(signalJets[3]);
  float dR_j3_j5 = -999; //me
  if (signalJets.size()>4) dR_j3_j5= signalJets[2].DeltaR(signalJets[4]);
  float dR_j3_j6 = -999; //me
  if (signalJets.size()>5) dR_j3_j6= signalJets[2].DeltaR(signalJets[5]);
  float dR_j4_j5 = -999; //me
  if (signalJets.size()>4) dR_j4_j5= signalJets[3].DeltaR(signalJets[4]);
  float dR_j4_j6 = -999; //me
  if (signalJets.size()>5) dR_j4_j6= signalJets[3].DeltaR(signalJets[5]);
  float dR_j5_j6 = -999; //me
  if (signalJets.size()>5) dR_j5_j6= signalJets[4].DeltaR(signalJets[5]);
